...
class LangFuseLogger:
    ...
    def _log_langfuse_v2(  # noqa: PLR0915
        ...
        try:
            ...
            tags = self._get_langfuse_tags(standard_logging_object=standard_logging_object) if self._supports_tags() else []
            ...
            if response_obj is not None:
                ...
                if _usage_obj:
                    ...
                    if hasattr(_usage_obj, "get"):
                        ...
                        cache_read_input_tokens = _usage_obj.get("cache_read_input_tokens") or 0
                    else:
                        cache_creation_input_tokens = getattr(_usage_obj, "cache_creation_input_tokens", None) or 0
                        cache_read_input_tokens = getattr(_usage_obj, "cache_read_input_tokens", None) or 0
