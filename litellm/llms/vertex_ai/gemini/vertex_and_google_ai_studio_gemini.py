...
class VertexGeminiConfig(VertexAIBaseConfig, BaseConfig):
    ...
    def _map_reasoning_effort_to_thinking_level(
        ...
        is_gemini3flash = model and ("gemini-3-flash-preview" in model.lower() or "gemini-3-flash" in model.lower())
        if reasoning_effort == "minimal":
            if is_gemini3flash:
    ...
    def map_openai_params(  # noqa: PLR0915
        ...
        if VertexGeminiConfig._is_gemini_3_or_newer(model):
            ...
            if "image" not in model.lower():
                ...
                if "thinkingLevel" not in thinking_config and "thinkingBudget" not in thinking_config:
        ...
        for part in parts:
            ...
            if is_thought or has_signature:
                block: ChatCompletionThinkingBlock = {
                    "type": "thinking",
                    "thinking": part.get("text", "") if is_thought else "",
                }
